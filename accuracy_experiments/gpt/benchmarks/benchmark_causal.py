...
from flash_attn_local.utils.benchmark import benchmark_forward, benchmark_all, pytorch_profiler
from flash_attn_local.flash_attn_interface import flash_attn_unpadded_qkvpacked_func
# from flash_attn_local.triton.fused_attention import attention as attention
from flash_attn_local.flash_attn_triton import flash_attn_qkvpacked_func
from flash_attn_local.flash_attn_triton_og import attention as attention_og

try:
    from flash_attn_local.fused_softmax import scaled_upper_triang_masked_softmax
except ImportError:
