...
class LMDataModule(LightningDataModule):
    ...
    def prepare_data(self):
        if self.cache_dir is None:  # Just download the dataset
            load_dataset(self.dataset_name, self.dataset_config_name, cache_dir="./cache")
    ...
    def process_dataset(self):
        ...
        raw_datasets = load_dataset(self.dataset_name, self.dataset_config_name, cache_dir="./cache")
